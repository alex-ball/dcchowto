...
pdf: $(EG)-tmp.md $(EG).bib $(NAME)-apa.csl
	...
	rm -f $(EG)-tmp.md
html: $(EG)-tmp.md $(EG).bib $(NAME)-apa.csl
...
inst: $(NAME).pdf html pdf dtp clean
	...
	cp $(NAME)-apa.csl $(UTREE)/tex/latex/$(NAME)
	cp $(NAME)-template.{latex,html} $(UTREE)/tex/latex/$(NAME)
	cp $(NAME).pdf $(UTREE)/doc/latex/$(NAME)
	cp $(EG).{bib,html,md,pdf,tex} $(UTREE)/doc/latex/$(NAME)
	cp $(EG)-preview.pdf $(UTREE)/doc/latex/$(NAME)
install: $(NAME).pdf html pdf dtp clean
	sudo mkdir -p $(LOCAL)/{tex,source,doc}/latex/$(NAME)
	sudo cp $(NAME).dtx $(LOCAL)/source/latex/$(NAME)
	sudo cp $(NAME).cls $(LOCAL)/tex/latex/$(NAME)
	sudo cp $(NAME)-apa.csl $(UTREE)/tex/latex/$(NAME)
	sudo cp $(NAME)-template.{latex,html} $(UTREE)/tex/latex/$(NAME)
	sudo cp $(NAME).pdf $(LOCAL)/doc/latex/$(NAME)
	sudo cp $(EG).{bib,html,md,pdf,tex} $(UTREE)/doc/latex/$(NAME)
	sudo cp $(EG)-preview.pdf $(UTREE)/doc/latex/$(NAME)
workmf: $(NAME).pdf html pdf dtp clean
	...
	cp $(NAME)-apa.csl $(WORKMF)/tex/latex/$(NAME)
	cp $(NAME)-template.{latex,html} $(WORKMF)/tex/latex/$(NAME)
	cp $(NAME).pdf $(WORKMF)/doc/latex/$(NAME)
	cp $(EG).{bib,html,md,pdf,tex} $(WORKMF)/doc/latex/$(NAME)
	cp $(EG)-preview.pdf $(WORKMF)/doc/latex/$(NAME)
zip: $(NAME).pdf html pdf dtp clean
	mkdir $(TDIR)
	cp $(NAME).{pdf,cls,dtx} $(EG).{html,pdf} $(EG)-preview.pdf README $(TDIR)
